...
router.get('/arcadyproxy', async(req, res) => res.sendFile(path.normalize(__dirname + '/views/arcadyproxy.html')));
router.get('/service/*', (req, res) => res.sendFile(path.normalize(__dirname + '/views/sw-boot.html')));
app.use(router);
